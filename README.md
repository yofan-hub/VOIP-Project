...
Hasil Analisis Kerentanan (UDP):Protokol: Paket langsung terdeteksi sebagai SIP.

Analisis Header: Diklik pada paket REGISTER atau INVITE  perhatikan bagian Session Initiation Protocol.
